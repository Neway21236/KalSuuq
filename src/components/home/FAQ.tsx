  ...
  const faqs = [
    {
      ...
      a: language === 'en' 
        ? "Yes, we offer nationwide shipping across Ethiopia. Delivery times range from 3-5 business days for locations outside the capital."
        : "አዎ፣ በመላው ኢትዮጵያ እናደርሳለን። ከአዲስ አበባ ውጪ ላሉ ከተሞች አቅርቦቱ ከ3-5 የሥራ ቀናት ይወስዳል።"
    },
    {
    ...
    },
    {
      ...
      a: language === 'en'
        ? "Absolutely. We prioritize local communication channels. You can find direct order links on every product page."
        : "በእርግጥ። ለሀገር ውስጥ የመገናኛ ዘዴዎች ቅድሚያ እንሰጣለን። በእያንዳንዱ ምርት ገጽ ላይ ቀጥታ ማዘዣ ሊንኮችን ያገኛሉ።"
    },
    {
      q: language === 'en' ? "How does the partner program work?" : "የአጋርነት ፕሮግራሙ እንዴት ነው የሚሰራው?",
      a: language === 'en'
        ? "Partners receive a unique referral link and code. When someone purchases through your link, you earn a commission on the total order value."
        : "አጋሮች ልዩ የሪፈራል ሊንክ እና ኮድ ይላክላቸዋል። በሊንክዎ አማካኝነት ግዢ ሲፈጸም ከጠቅላላው ሽያጭ ላይ ኮሚሽን ያገኛሉ።"
    }
  ]
